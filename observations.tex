...
This procedure is used in EHT3 \citetalias{PaperIII} to set an upper limit of $95\mu$as on
...
We will assume that the 86GHz variability over spans of order $3$days is fully captured by the model.
