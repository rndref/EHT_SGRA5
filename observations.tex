...
Here we consider two measures of variability: one that characterizes variability of 230\GHz flux density in the ALMA light curves \citep{Wielgus2022} and a second one that characterizes variability of the visibility amplitudes in EHT data \citep{PaperIV, NoiseModeling}.
