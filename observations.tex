...
\cfg{heavily edited to make consistent with length and tone of other
  constraints, and to remove figures.}
...
For the ``long baseline'' interval between 6--8\,G$\lambda$, the visilbity amplitude has $\simless 6\%$ of the zero-baseline flux, always.
