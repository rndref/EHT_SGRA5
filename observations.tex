...
We evaluate the fraction of snapshots from each model that are compliant using the criteria described above.
If the compliance fraction is $< 1\%$ the model is categorized as failed.
