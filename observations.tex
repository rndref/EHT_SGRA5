...
For each model we evaluate a light curve and use that to generate a distribution of $\mi{3}$.  We then use a KS test to ask whether that distribution is consistent with the historical distribution.\footnote{We can also use light curves from the 2017 campaign alone, which rejects {\em more} models.  The 2017 campaign light curve samples are consistent with having been drawn from the full historical dataset.}
