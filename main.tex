...
\begin{abstract}
  ...
  A number of models fail only the variability constraints, and we identify a promising cluster of these models which are strongly magnetized (MAD) and have inclination $i \le 30$.
  ...
  We also find that: all models with $i \ge 70$ fail at least two constraints, as do all models with equal ion and electron temperature;  exploratory, nonthermal model sets tend to have higher 2.2\um flux density; the population of cold electrons is limited by X-ray constraints due to the risk of bremsstrahlung overproduction.
