...
%==============================================================================
\section{Fiducial Accretion Models of \sgra}
\label{sec:fiducial}
...
pre-EHT2017 data.
The large amount of observation and theoretical studies lead to ...
...
Then
$\nu L_\nu = 4 \pi d^2 \nu F_\nu = 1.8 \times 10^{34} (d/8127 \pc)^2 \times\allowbreak (\nu/230 \GHz)(F_\nu/{\rm Jy}) \erg \sec^{-1}$.
The Eddington luminosity for \sgra is
$L_\mathrm{Edd} = 4\pi G\mbh c/\kappa_{es} = 5.2 \times 10^{44}\allowbreak\erg\sec^{-1}$.
...
%==============================================================================
\section{Image and Spectrum Modeling}
...
\end{align}
The density scale $\rho_0$ is a free parameter that we need to
constraint.
...
%==============================================================================
\section{EHT Observation Modeling}
