...
%==============================================================================
\section{Observables from Forward Modeling}
...
local minima and study how the fits change as one vary the hyper
paramters.
Similar method is proposed in the imaging WG to understand different
...
%------------------------------------------------------------------------------
\section{GRMHD Resolution and Convergence}
\label{sec:converge}

\note{Ensure that SANE and MAD simulations are run long enough so the
  accretoin flows reach status states.
...
%------------------------------------------------------------------------------
\section{Image Resolution and Field of View}
\label{sec:res-FoV}
...
%------------------------------------------------------------------------------
\section{Fast Light vs Light-Speed Light}
