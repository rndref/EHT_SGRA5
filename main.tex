...
%% Here, we summarize various results on \sgra using pre-EHT2017 data.
...
%% \sgra is one of the most well-characterized objects on the
%% sky. Simultaneous and non-simultaneous observations at $230$GHz and
%% other frequencies have the potential to sharply constrain models.
...
%------------------------------------------------------------------------------
\subsection{230\,GHz VLBI Size Constraint}
\label{sec:230size}
...
%------------------------------------------------------------------------------
\subsection{230\,GHz VLBI Asymmetry Constraint}
\label{sec:230asym}
...
%------------------------------------------------------------------------------
\subsection{230\,GHz VLBI Variability Constraint}
...
%------------------------------------------------------------------------------
\subsection{86\,GHz Size Constraint}
\label{sec:86size}
