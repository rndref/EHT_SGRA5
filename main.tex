...
%==============================================================================
\section{Fiducial Accretion Models for \sgra}
\label{sec:fiducial}
...
We start with an one-zone model, which will give us the order of
magnitude estimate of the physical properties \sgra.
We will ...
For the innermost accretion disks, GRMHD and GRRT will be used to
capture the dynamics, thermodyanmics, and ...

We also summarize some phenomenological models in ...
...
%------------------------------------------------------------------------------
\subsection{Plasma Models and Electron Distribution Functions}
\label{sec:eDF}
