...
% Paper central is here: https://eventhorizontelescope.teamwork.com/#/notebooks/181896
% Comment notebook is here: https://eventhorizontelescope.teamwork.com/#/projects/387750/notebooks/237168
...
This paper is dedicated to the memory of John F. Hawley, whose pioneering work on black hole accretion flows made this paper possible.   
...
\software{\bhac, \bhoss, \difmap, \dmc, \ehtim, \foci,
  \grmonty, \hallmark, \hamr, \ipole, \kharma, \koral, \mockservation,
  \smili, \themis, \vida, VisIt, numpy, scipy, matplotlib}
