...
hole was predicted theoretically before it was observed.
By applying the black hole model of quasars,
\citet{1971MNRAS.152..461L} first predicted that a supermassive black
...
breakthroughs and have advanced our understand of black holes.
...
\note{Briefly describe other relevant numerical works
  \citep{2003ApJ...589..444G, 2019ApJS..243...26P}.}

These theoretical and numerical works have led to a standard model of
the \sgra.
...
However, even the most sophisticate models to date are not able to
fully explain all the details saw in observations.
...
In this Letter, we adopt the standard model that \sgra is a black hole
described by the Kerr metric, with mass $M$ and dimensionless spin
$a*$ within the range $-1 < a_* < 1$.
