...
\note{Ensure that MAD simulations are run long enough so the accretoin
  flow reaches a status state.
  Maybe cite MAD code comparison paper and \citep{2012MNRAS.426.3241N,
...
\note{Show work in ``Field-of-View and Resolution Requirements for
  Simulations of Sgr~A*'' by Antonios Nathanail, Avery Broderick,
