...
\cmf{Hector is working on the results from the BHAC runs including non-thermal emission models, should be done over the weekend}\monika{but we decided to close the results dumping into the draft today at midnight}
...
at the event horizon; the quantity in the parenthesis is the inward rest-mass energy flux. Figure \ref{fig:accretion_illinois_thermal} shows $\dot{M}$ (in units of solar masses per year) for the Illinois/Thermal models.

Our findings: (1) The MAD models accrete on average, at $10^{-9}-10^{-8} M_{\odot}$yr$^{-1}$ while the SANE models have a broader range, $10^{-9}-10^{-6} M_{\odot}$yr$^{-1}$. (2) $\dot{M}$ increases with increasing $\Rh$. Since the electron temperature inversely varies with $\Rh$, a greater $\Rh$ implies cooler electrons. To maintain an average flux density of 2.4Jy at 1.3 mm, the corresponding $\mathcal{M}$ increases. (3) The SANE models exhibit a more pronounced change in $\dot{M}$ with changes in $\Rh$ as compared to the MAD models. The emission in the SANE models is predominantly from regions with large plasma $\beta$, where the electron temperature is regulated by $\Rh$; MAD models produce a significant fraction of the emission in regions with $\beta\sim 1$, where $\Rh$ does not notably influence electron temperature (cf. Figure 4 in \citet{M87PaperV}). (4) The retrograde, SANE, $\Rh=40$ and $160$ models produce the largest accretion rates, $\dot{M}\sim 10^{-6}M_{\odot}$yr$^{-1}$. However, these models are ruled out due to overproduction of x-ray emission. (5) The Illinois models with the critical-$\beta$ electron temperature assignment scheme predict accretion rates that lie between the $R_{high}=10$ and 40 values for the chosen set of parameters ($f=0.5$, $\beta_{crit}=1$).

There have been several studies at radio, X-ray and $\gamma$-ray that have suggested the presence of a mildly relativistic outflow  based on morphological structures observed in the \sgra complex (\citealt{2012ApJ...758L..11Y,2012AAS...22051303S,Li_2013,2019ApJ...875...44Z} and references therein \monika{cite one of the classical Zadeh paper who claimed to see a jet on larger scales in radio?}\vd{Done. Not including all works that mention the possibility of a jet in \sgra to avoid references dump}). However, the low luminosity and high variability of \sgra, and the presence of a dominant, interstellar scattering screen \vd{refs...} \monika{citations for ism scattering previously in intro}(\citealt{2016ApJ...824...40O,2017MNRAS.471.3563D,2018ApJ...865..104J,2019A&A...621A.119B,2018ApJ...865..104J})
 have precluded direct detection of a jet in the galactic center. Here we present the outflow power (defined below) in our numerical models and discuss the likelihood of such a jet.\monika{I suggest to move this paragraph to after you cite Markoff paper about hiding jet in galactic center...}\vd{i figured the ambiguity in the presence of a jet in \sgra motivates the use of $P_{out}$ instead of $P_{jet}$.}

\monika{I suggest to first say that our models produced outflows and jets}\vd{Now?} Numerical simulations of black hole accretion have consistently demonstrated the presence of relativistic outflows ``jets'' in the polar regions. \vd{refs. McKinney \& Gammie, 2004 +}. In the past, several authors have defined the jet differently: \citet{refId0}, \citet{2014A&A...570A...7M} use a Bernoulli parameter Be, while \citealt{10.1111/j.1365-2966.2012.22002.x} consider the ratio of energy flux to rest mass flux $\mu$, and \citet{M87PaperV} apply a $\beta\gamma$ cut to define $P_{jet}$. 

Due to lack of an observational estimate of \sgra's jet power, we instead evaluate the total, mechanical, outflow power near the poles \citep{M87PaperV},
...
The time-averaged, outflow power in the Illinois/Thermal models are plotted in Figure \ref{fig:outflow_illinois_thermal}. $P_{out}$ increases with increasing the magnitude of black hole spin $|a_{*}|$. Many of our high spin models attain an outflow power $P_{out}\sim 10^{38}$ ergs s$^{-1}$. \vd{Is it possible to hide such outflows in the galactic center? \citet{2007MNRAS.379.1519M} talk about this. However, their analysis prefers edge-on models, which are disfavored in the present work.}

\begin{figure*}
\centering
\includegraphics[width=0.95\textwidth]{figures/illinoisv3_average_mdot.png}
\caption{Accretion rates for the Illinois/Thermal models at observer inclination $i=50^{\circ}$. Since $\dot{M}$ is weakly dependent on the observer inclination angle, we plot for a single $i$.}
...
\caption{Outflow powers for the Illinois/Thermal models at an observer inclination $i=50^{\circ}$. The colors and markers are the same as \ref{fig:accretion_illinois_thermal}.}
