...
We have carried out a first comprehensive comparison of the EHT 2017 \sgra data to a state-of-the-art library of numerical models.  None of the models survive the full gauntlet of 11 heterogeneous observational constraints.  In our standard model set, however, a cluster of strongly magnetized (MAD) models at intermediate inclination, positive spin, and large ($\Rh \ge 40$) ion-electron temperature ratios survive 10/11 constraints 

While none of the models survive the full gauntlet of 11 heterogeneous observational constraints,  
