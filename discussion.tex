...
For M87* we were able to identify a sense of rotation of the source from the asymmetry of the observed ring.  For \sgra we have not been able to identify a preferred position angle for the source or measure source asymmetry \citep{PaperIV}.  This is largely due to sparse baseline coverage.  Future EHT campaigns with new stations have the potential to remedy this defect.  Unless the source is aligned and $i \approx 0$, all our standard models predict that the brightest point should lie on the approaching side of the accretion flow.  Failure to observe a clear 
