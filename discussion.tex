...
We have carried out a first comprehensive comparison of the EHT 2017 \sgra data to a state-of-the-art library of numerical models.  None of the models survive the full gauntlet of 11 heterogeneous observational constraints, but in our standard model set a cluster of strongly magnetized (MAD) models at intermediate inclination, positive spin, and large 
