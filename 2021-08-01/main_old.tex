...
%------------------------------------------------------------------------------
%MOVED from Sect. 3.1 to Sect 3.0 in accordance with Monika discussion 7/23/21
...
%The insights gleaned  have led to the development of analytic disk ``$\alpha$-model" for angular momentum transport \cite{Shakura1973}. 
...
\tablehead{
  ...
  \colhead{86\,GHz}  & \colhead{230\,\mathrm{GHz} 2nd moment} & \colhead{Null Location} & \colhead{v3 $\sigma/\mu$}  & \colhead{NIR}  & \colhead{X-ray} & \colhead{All} % 4 constraints + 1 combined
}
\startdata
