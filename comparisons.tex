...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{figures/mring_width_example.pdf}
...
\kc{Due to the additional power-law component, the 86\GHz image sizes for the hybrid \hamr models are, on average, larger than their thermal-only counterparts. }
...
