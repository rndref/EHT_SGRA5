...
Notably, $\mi{3}$ lightcurve variability performs much better when adding a power-law component to the eDF, possibly due to a more extended emission region.
...
%, with the largest differences for the lightcurve variability and the VA morphology.
