...
However, since the $\mi{3}$ constraint is computed for a time window of length only 5000\tg$, a factor three shorter than for the thermal models, this increase does not increase the fraction of models ruled out by this constraint.
