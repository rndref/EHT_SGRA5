...
If we were to apply the variability constraints directly to the models there would be M/N successful models left.  One interpretation is that these models are the correct description of the source (although we expect some errors
