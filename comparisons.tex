...
(Figure~\ref{fig:non_eht_cuts}), we further narrow down \sgra to two
temperature models.

%% While there are also isolated pockets in the parameter space that
%% pass many constraints, however, even with an extensive study like
%% this, it is difficult to draw strong conclusion about these
%% isolated regions.
%% Do these models pass all constraint by ``luck'' and are simply
%% noise?
...
nonthermal), and live inside clusters of passing models in the
parameter space.
