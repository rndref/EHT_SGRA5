...
The second moment constraint passes $98\%$ of all models.
...
The \vam constraint tests the null location and long-baseline VAs for the model.  Figure~\ref{fig:passfail_va} shows an example of a passing and failing model.  
...
The null location constraint passes 77\% of all models.
...
Many rejected models are at high inclination models and $\abh =0.94$.
...
The ring diameter test passes 55\% of all models.
...
The 86\GHz size constraint passes $58\%$ of models and is therefore one of the tightest constraints.
...
The high-energy variability observed in many astrophysical sources including the galactic centre may be associated with 
...
We use the emissivities and absorptivities from  \cite{2016ApJ...822...34P}, computed numerically for the interval $3 < \kappa \le 8$.
...
In tilted disks, accretion occurs via thin plunging streams \citep[e.g.,][]{Fragile2007} where electrons in the shocked flow can be heated to relativistic temperatures \citep[e.g.,][]{Dexter2013, 2014ApJ...780...81G, White2019}, forming localized, fluctuating hotspots more easily than in aligned disks and increasing flux variability \citep{Chatterjee2020, 2021arXiv210412896W}.  Nevertheless, 20/27 models pass the \mi{3} constraint because of the short duration of the tilted models, which provide far fewer \mi{3} samples than the fiducial models.
