...
\citet{Georgiev_2022} gives an estimate for the width of the distribution as $\log_{10}(\sigma_\text{var}^2) \pm 0.1$. We can get a rough estimate for how the GRMHD models fare compared to the measurement by taking the mean across windows and the estimate for the width, and comparing this with the measurement distribution. Under this, 83/200 models (46 SANE and 37 MAD) are within 1\% of the measurement, although we caution against interpreting this number as the number of passing or failing models, since the uncertainties in the model distribution are so large. 
