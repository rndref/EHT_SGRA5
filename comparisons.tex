...
We now consider combined constraints, excluding variability, under the hypothesis that (1) there is a missing ingredient in the models that would lower variability, (2) without vitiating the models entirely.   
