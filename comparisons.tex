...
The stellar wind fed models of \cite{2020ApJ...896L...6R, 2020MNRAS.492.3272R, 2018MNRAS.478.3544R}, which track plasma from  magnetized stellar winds down to the event horizon, provide a self-consistent picture of the origin of both gas and magnetic fields for the accreting plasma in \sgra.  The resulting inflow does not fully circularize and so the model also provides a distinct alternative to the MAD and SANE
