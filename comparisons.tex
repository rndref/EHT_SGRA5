...
\ckc{I still think thermal vs nonthermal models is better...}
...
First we consider the consequences of changing the $\Rh$ temperature assignment scheme in thermal models.  The $\Rh$ prescription has been the default parameterization.  Assuming that the ion-electron temperature ratio $R$ depends instantaneously on local conditions restricts the range of possibilities but still leaves a large function space of possibilities.  One well-motivated alternative is the critical beta model \citep{2020MNRAS.493.1404A}, which sets $T_e = f (T_e + T_i) \exp(-\beta/\beta_c)$.  This model has two parameters, $f$ and $\beta_c$.  Here we consider a single point in the parameter space, $f = \beta_c = 1$.
...
\begin{deluxetable*}{ccccccc}
  ...
  \startdata
  A & 0.5  & MAD     & torus    & thermal                               & 160 & 30  \\
  B & 0.94 & SANE    & torus    & thermal                               &  40 & 30  \\
  C & 0    & SANE    & wind-fed & thermal                               &  40 & 30  \\
  D & 0.94 & IN-SANE & tilted   & thermal                               &  40 & 30  \\
  E & ...  & ...     & torus    & nonthermal fixed efficiency power law & ... & ... \\
  F & ...  & ...     & torus    & nonthermal fixed efficiency $\kappa$  & ... & ... \\
  G & ...  & ...     & torus    & nonthermal variable $\kappa$          & ... & ...
  \enddata
  %
