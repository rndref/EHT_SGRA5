...
Recall that we compare the distribution from the data to that from the model using a two-sample KS test. %cmf need to call it also two-sample KS in the constraint section?
...
The three non-thermal models have an average passing fraction for the Null location of 80\% whereas 84\% of the thermal models pass.
The 4 \texorpdfstring{$G\lambda$}{Gl} visibility amplitude variability constraint passes 72\% of the models for both thermal and non-thermal eDF.
...
% cmf 2/10 this was requested by Andrew and Jordy, maybe too much
...
Only 60\% of the $\kappa$ models pass the4 \texorpdfstring{$G\lambda$}{Gl} visibility amplitude variability constraint, in contrast to 72\% of the thermal models.
