...
We now consider combined constraints, excluding variability, under the hypothesis that (1) there is a missing physical ingredient in the models that would lower variability, (2) without vitiating the models entirely.  The combined constraints are applied by 
