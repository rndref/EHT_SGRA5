...
\begin{figure*}
  ...
  \caption{Visibility amplitude plots for demonstrating the null
    ...
    For the above examples, the left model failed because the $u$-$v$
    distance of first null is too short; the middle model failed
...
This implies that either (1) the models are wrong, or (2) some of the data underlying the model tests are incorrect (, or (3) the constraints have been misapplied.  
