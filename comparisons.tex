...
\begin{figure*}
  ...
  \caption{Visibility amplitudes (left) and SEDs (right) of the three featured models, compared with the data.  Black symbols show observations.  Blue, orange, and green are Models~A, B, C, respectively (see Table~\ref{tab:bestbets} for details).  Observed VAs are 10\sec incoherently averaged data from the HOPS pi
