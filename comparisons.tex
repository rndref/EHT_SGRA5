...
\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{./figures/koral_MI.png}
...
We now consider combined constraints, excluding variability, under the hypothesis that (1) there is a missing physical ingredient in the models that would lower variability, but (2) that missing ingredient would not vitiate the model comparison proc entirely.  Models are eliminated if they fail any one constraint.
