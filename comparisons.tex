...
The second moment constraint passes 99\% of models.  The models that fail are retrograde, face-on, SANE models with $\Rh = 1$. These models have extremely extended rings of emission with angular extent much larger than the critical impact parameter.
