...
\begin{figure}
  ...
  \caption{Distribution of \mi{3} from the full \koral model set, from the first half, from the second half, and from the comparable Illinois thermal models.}
  \label{fig:koral_MI}
\end{figure}  
