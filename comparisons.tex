...
\begin{figure*}
  ...
  \caption{We show here the 86\GHz and 230\GHz ray traced images of
    ...
    10$\,\mathrm{G}\lambda$.
    The resulting images approximate the resolution of the 2017 EHT
    array.}
  \label{fig:bestbet_imgs}
\end{figure*}

\ckc{We don't have pizza plot for all the constrants now in the main text?}
...
Amoung the tens of models that pass all constraints (see
Appendix~\ref{sec:tables}), we feature three models in this section,
summarized in Table~\ref{tab:bestbets}.

These models are selected in the following ways.
Because of the model and observation noise
...
pass all the constraints we described in this paper.
