...
The MAD models that fail tend to sit at large absolute spin and low $\Rh$.  These models are Compton-dominated and are therefore temperature sensitive, and so are at greater risk at low $\Rh$.  
...
After all non-EHT constraints are applied, and only non-EHT constraints, we are left with the models shown in Figure \ref{fig:non_eht_cuts}.   
