...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{figures/passfail_sz.pdf}
  \caption{\ckc{To be written...} Face-on images are too big.}
...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{figures/passfail_va.pdf}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figures/passfail_sed.pdf}
...
\begin{deluxetable*}{cccccc}
  ...
  \startdata
  A & 0.5  & MAD  & thermal                      &  40 & $30\degree$ \\ % Illinois
  B & 0.94 & SANE & thermal                      &  40 & $30\degree$ \\ % Frankfurt
...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{figures/bestbet_C.pdf}
  \caption{Feature model C}
  \label{fig:bestbet_C}
\end{figure*}
