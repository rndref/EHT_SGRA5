...
We compute $mi{3}$ for a window of $5000\tg$ (note that this is shorter than the standard models, so the results are less constraining).  We find that the fraction of models 
