...
\subsubsubsection{Frankfurt Models}
...
We have also considered a set of thermal, $\Rh$, MAD models run with the \koral code out to $\sim 100,000\tg$.  These models help control for the effect of finite 
