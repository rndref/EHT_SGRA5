...
In brief, we do not see evidence for evolution in this particular model set.  We find that the \koral pass/fail results are similar to those for comparable models in the Illinois thermal model set.  

The \koral model constraint results are similar to those for the Illinois thermal model set.  The key question is whether the models evolve in any of the tests over the integration time.  We find little evidence for    

%------------------------------------------------------------------------------
\subsubsection{Inter-Model Comparison: Critical Beta Model}
