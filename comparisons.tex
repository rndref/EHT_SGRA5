...
\begin{figure*}
  ...
  \caption{%
    ...
    $-90\degree$ (horizontal), $-45\degree$, $0\degree$ (vertical),
    and $45\degree$.
    ...
    8$\,\mathrm{G}\lambda$ marks both the $(u,v)$ distance that we
    need to compute the long-baseline amplitude, and the allowed
    median values of the normalized visibility amplitude,
    $\mathrm{median}[V(6\,\mathrm{G}\lambda \leq \lambda \leq
    ...
    The right model fails the \vam\ constraint because none of the
    first null is the allowed range and all median amplitudes are above
    4\%/50\%.}
