...
\cmf{text from Alejandro: The post-processing radiative transfer is done employing the GRRT code \bhoss using GRMHD simulations from the \bhac. We use the time window from $\rm 25,000M-30,000M$ and we created images every $\rm 10M$ normalizing the average flux of $\rm 2.4\,Jy$ at $\rm 230\,GHz$. \subsubsubsection{Null Location}
...
The addition of nonthermal particles increases the x-ray emission from the majority of models.
...
\begin{figure*}
  ...
  \ckc{Will update snapshot once receipt the consensus image from PaperIII}
  }
