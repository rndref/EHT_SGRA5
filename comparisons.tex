c\section{Model Comparison}\label{sec:comparisons}
...
\begin{figure*}
  ...
  \caption{Featured models 86\GHz and 230\GHz images.  The columns show models ~A, B, and C from Table~\ref{tab:bestbets}, rows show 
  We show here the 86\GHz and 230\GHz ray traced images of
