...
\begin{figure}
  \caption{\ckc{Add a two panel figure show a model fail and a model pass the 2nd moment constraint.}}
...
\begin{figure}
  ...
  \caption{
    \ckc{This figure will be trimmed down to demonstrate how a constraint work vs not work.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This figure is for the feature model section
\begin{figure*}
  \centering
