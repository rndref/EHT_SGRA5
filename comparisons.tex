...
Next we consider a mixed thermal/nonthermal eDF, with the nonthermal component following the kappa DF.  We set $\kappa = 3.5$
...
\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{figures/best_va.png}
  \caption{The visibility amplitudes of two selected possible models.}
  \label{fig:best_va}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{figures/best_sed.pdf}
  \caption{The SEDs of two selected possible models.}
  \label{fig:best_sed}
\end{figure}
