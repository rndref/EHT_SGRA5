...
Notice that the ring diameter is not degenerate with the second moment constraint; all models that fail the latter pass the former.  The m-rings contain a centered Gaussian component that tends to grow to absorb the emission from broad rings.   
...
We can combine all EHT constraints with a logical {\em and} operation.  The results are summarized in Figure  \ref{fig:all_EHT_constraints}.  The cuts favor $\abh > 0$ models.  We are left with $33/100$ SANE models and $16/100$ MAD models.
