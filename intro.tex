...
The Event Horizon Telescope (EHT) is a Very Long Baseline Interferometric (VLBI) experiment operating at $\lambda = 1.3\mm$ (or frequency $\nu = 230\GHz$).  It operates at frequency high enough to penetrate the scattering screen, with angular resolution sufficient to directly image the intrinsic \sgra structures in the immediate vicinity of the black hole event horizon.
