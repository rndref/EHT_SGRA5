...
In this appendix we present the full results of the constraint
application in both graphical and tabular form.
We start with the Illinois thermal model set.
We first present plots about the EHT-based constraints.
