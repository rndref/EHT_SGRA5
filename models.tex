...
\begin{align}
  \frac{d n_e}{d\gamma} =
  n_e \frac{ (p-1)}{(\gamma^{1-p}_\mathrm{min} - \gamma^{1-p}_\mathrm{max})} \gamma^{-p}
...
\note{Entire image library contains $MMM$ model sets, $NNN$ models, and $PPP$ images, and occupies $GGG$ gigabytes.}
...
\tablehead{
  ...
  \colhead{SED}                    &%
  \colhead{$\Delta t$}    &%
  \colhead{\#230Ghzimages/GB}       \\
 &  & & & & & & & \colhead{[GHz]} & & \colhead{[1000 M]} &
    }
\startdata
\multicolumn{12}{c}{\bf Thermal models}\\
KHARMA & 1 & [1,10,40,160] & 1 & - & - & - & [10,30,...,170] & [86,230] & yes & [15,20) & x \\
KHARMA & 1 & [1,10,40,160] & 1 & - & - & - & [10,30,...,170] & [86,230] & yes & [20-25) & x \\
KHARMA & 1 & [1,10,40,160] & 1 & - & - & - & [10,30,...,170] & [86,230] & yes & [25-30) & x \\
...
\hline
\multicolumn{12}{c}{\bf Non-thermal power-law models}\\
HAMR & 1 & [1,40,160] & 1 & 4 & - & - & [10,50,90]  & [86,230] & no & [30-35) & x \\
\hline
\multicolumn{12}{c}{\bf Non-thermal $\kappa$ models}\\
- & - & - & -  & - & 5 & & & & & \\
...
\enddata
\caption{Summary of emission simulations in \sgra EHT model library.\kc{flipped PL and kappa, and propose to remove $\gamma_{\rm min/max}$ from the table as it is a local quantity in hamr models}}~\label{tab:radiativemodels}
\end{deluxetable*}
%\end{rotatetable}
