...
We use two classes of numerical methods: ray tracing to generate synthetic images, and a Monte Carlo scheme to generate spectral energy distributions (SEDs).
Further detail on numerical methods is given Appendix~\ref{app:radtrans}.
Comparisons of numerical methods \citep{2020ApJ...897..148G, Prather_et_al_2021} show that differences between numerical schemes do not contribute significantly to the error budget.

The models are imaged at 86\GHz, 230\GHz\footnote{The mean frequency for  EHT observations is more nearly 228\GHz.} and 2.2\um (near infrared, NIR hereafter).
...
In Figures~\ref{fig:fiducial_86GHz}, \ref{fig:fiducial_230GHz}, and \ref{fig:fiducial_SEDs}, we present a representative set of model images and multiwavelength SEDs from our library.
...
\begin{figure*}
  ...
  \caption{Snapshot 86\GHz and 230\GHz images and corresponding time-averaged SEDs from the simulation library:
    ...
    \ckc{will break this into 3 figures so we can freely pick re representative sets of examples.}}
