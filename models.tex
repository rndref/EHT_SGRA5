...
\end{align}
Here $u$ and $\rho$ are the internal energy density and rest-mass density from the GRMHD simulation, and we have assumed that the ions are nonrelativistic with adiabatic index $5/3$ and the electrons are relativistic with  adiabatic index $4/3$. %\cmf{table 1 says 4/3 for both}
