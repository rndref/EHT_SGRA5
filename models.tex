...
characteristic length ${\mathcal L}  \equiv G M/c^2        \approx 6.1\times10^{11}\cm$,
characteristic time   ${\mathcal T}  \equiv G M/c^3        \approx 20.5\sec$, and
angular scale         ${\vartheta_g} \equiv G \mbh/(c^2 D) \approx 5.03\uas$.
