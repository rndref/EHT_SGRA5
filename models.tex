...
We simulate the plasma flow with an ideal GRMHD\footnote{Notice that ideal GRMHD models do not fully capture collisionless aspect of the accretion flow and jets; we discuss the model limitations in  Section~\ref{sec:limits}} model, assign an electron distribution function, and solve the radiative transfer equation along geodesics to produce synthetic observations.
