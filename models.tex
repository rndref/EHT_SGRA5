...
\begin{figure*}
  \centering
  \includegraphics[width=0.32\textwidth]{figures/sane_3D.png}%
  \includegraphics[width=0.32\textwidth]{figures/ressler_3D.png}%
  \includegraphics[width=0.32\textwidth]{figures/mad_3D.png}
  \caption{3-D overview of selected GRMHD simulations of \sgra in our library. The color marks constant dimensionless density surfaces and lines are magnetic field lines. Panels from left to right show SANE ($a_*=+15/16$), Wind Accretion ($a_*=0$), and MAD ($a_*=$) models.\monika{plots are not final, more detailed quantitative plots of models are expected to be in the appendix.}}
  \label{fig:GRMHD}
\end{figure*}
