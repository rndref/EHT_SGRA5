...
In what follows, we will assume that the radiative cooling of plasma around the black hole can be neglected (which is justified in the next sections) and that model emission can be calculated as post-processing.
...
In Figure~\ref{fig:GRMHD} we show a few examples of GRMHD runs with both standard torus and non-standard GRMHD runs.
...
\begin{figure*}
  ...
  \caption{3-D overview of selected GRMHD simulations of \sgra in our library.
    ...
    Two top panels show accretion models with standard torus initial condition: SANE (left panel, $\abh=0.94$) and MAD (right panel, $\abh=0.5$).
