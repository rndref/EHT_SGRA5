...
\end{align}
which has power-law index $p_\mathrm{pl}$ and upper and lower limits  $\gamma_{\min}$ and $\gamma_{\max}$,
or
...
\begin{figure*}
  ...
  \caption{Snapshot 86\GHz and 230\GHz images and corresponding time-averaged SEDs from the simulation library:
    ...
    \monika{labels have to be made larger}
    ...
    \monika{I suggest to make big white labels on images with frequency and viewing angle and model type, window time we can give in figure caption. SEDs could have small arrows pointing at which frequency in the SED the images are made demonstrating that we see only synchrotron emission at 86 and 230 GHz (and no e.g. bremsstrahlung), spins could be also mentioned in figure caption.}}
