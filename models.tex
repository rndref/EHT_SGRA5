...
\footnote{The cooling time for 2.2$\um$ emitting electrons is $\sim 60 (B/(30 {\rm G}))^{-3/2} \tg$, so cooling is a more significant source of uncertainty for model 2.2$\um$ predictions.}
