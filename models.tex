...
characteristic length $r_\mathrm{g}         \equiv G\mbh/ c^2    \approx 6.1\times10^{11}\cm$,
characteristic time   $t_\mathrm{g}         \equiv G\mbh/ c^3    \approx 20.5\sec$, and
angular scale         $\vartheta_\mathrm{g} \equiv G\mbh/(c^2 D) \approx 5.03\uas$.
...
\ckc{In principle, we could check all of the assumptions in the one zone model for consistency.  Probably leave until after PC submission.}
