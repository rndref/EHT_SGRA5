...
of the ucla and mpe values?}\monika{to be honest I dont understand where these numbers come from,  someone from parameter definition wg should check this. Table 1 in gravity paper reports mass: 4.148+-0.014 distance:8175, while Do: (assuming gravity is valid) mass:3.964+-0.047 distance:7946}
...
\begin{figure*}
  ...
  \caption{Sample SEDs from the sample models shown in
    ...
    fluxes at 86\GHz and 230\GHz, and the upper limits at NIR and x-ray. \monika{Lines with different colors show contribution to the total emission from different physical processes (e.g., direct synchrotron emission, inverse-Compton emission from or bremsstrahlung). The total emission is marked as black spectrum. Btw. I suggest that we show spectra beyond $10^{22}$ Hz, it seems like there is some emission there, it looks ugly to cut it.}}
