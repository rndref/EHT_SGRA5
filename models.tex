...
\begin{figure*}
  ...
  \caption{Sample SEDs from the sample models shown in
    ...
    synchrotron emission, inverse-Compton emission from or
    bremsstrahlung).
    The total emission is marked as black spectrum.
    \monika{Btw. I suggest that we show spectra beyond $10^{22}$ Hz, it seems like there is some emission there, it looks ugly to cut it.}
    \ckc{Fixed x-range}}
