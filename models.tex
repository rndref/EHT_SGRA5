...
\begin{figure*}
  ...
  \caption{Sample SED from the simulation library:
    ...
    (\emph{right})~a non-thermal variable $\kappa$ MAD.
    Note that these models do not necessary pass any of the constraints.
    They simply demonstrate the variety of possible SEDs.\monika{small suggestion is to break the legend into 3 columns and place it above the entire plot, I mean outside of the boxes, this way they will be nicely split in width and can add this to images plot}
