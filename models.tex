...
Plasma heating models suggest that energy dissipation to ions and electrons depends on the local magnetic properties \citep[e.g.,][]{2010MNRAS.409L.104H, Kawazura771}.
We therefore use a prescription in which the temperature ratio is a function of the plasma $\beta \equiv P_\mathrm{gas}/P_\mathrm{mag}$ \citep{2015ApJ...799....1C}.
...
In the standard models presented in this paper $\Rl = 1$ and $\beta_\mathrm{crit} = 1$, and $\Rh$ varies from 1 to 160.
...
Evidently, any eDF assignment scheme is an approximation in the sense that the eDF will in general depend on both local conditions and particle histories.
...
Comparisons of numerical methods \citep{2020ApJ...897..148G, Prather_et_al_2022} show that differences between numerical schemes do not contribute significantly to the error budget.
