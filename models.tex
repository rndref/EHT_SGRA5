...
\begin{figure*}
  ...
  \includegraphics[width=0.5\textwidth]{figures/whatever_3D.png}\\
  \caption{3-D overview of selected GRMHD simulations of \sgra in our library. The color marks constant density surfaces and lines are magnetic field lines. Panels from left to right show SANE ($a_*=$), Wind Accretion, MAD ($a_*=$) and x models.\monika{plots are not final, more detailed quantitative plots of models are expected to be in the appendix.}}
  \label{fig:GRMHD}
\end{figure*}
