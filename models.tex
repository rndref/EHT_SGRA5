...
\begin{figure*}[]
  [altex: grid plot showing equaltorial and verical slides, and $phi$ averaged density, temperature, etc of MAD and SANE.]
...
\begin{figure*}[]
  ...
  \caption{Emissivity from thermal, critical beta, kappa, and variable kappa models.}
  \label{fig:data_comp}
\end{figure*}
...
\begin{figure*}[]
  [altex: Fiducial images at different wavelenghts]
  \caption{Fiducial images at different wavelenghts.}
