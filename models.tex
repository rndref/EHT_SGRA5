...
\begin{deluxetable*}{cccccccccc}\label{tab:GRMHDmodels}
  ...
  torus    & \koral$^d$    & 0, $\pm 0.3$, $\pm 0.5$, $\pm 0.7$, $\pm 0.9$ & MAD      & $\frac{13}{9}$             & 101,000 & --- & --- & 100,000  & $288\times192\times144$     \\
  ...
  \tablecomments{Summary of the EHT \sgra GRMHD simulation library.
    ...
    of $G M/c^2$.}
  \tablerefs{$^a$see \cite{2021JOSS....6.3336P}; \kharma is a
    GPU-enabled version of the {\tt iharm3d} code.
