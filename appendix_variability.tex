...
Figure~\ref{fig:mi_rlow} shows the \mi{3} distribution for a set of four \kharma models with four values of $\Rh$ (1,2,5, and 10).  Evidently the \mi{3} distribution does not exhibit a clear trend with $\Rh$, and is still inconsistent with the observed distribution even at $\Rh = 10$.  
