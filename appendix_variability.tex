...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{figures/ctcut_lightcurves.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{figures/ctcut_effects.pdf}
...
The thermal models considered in Section~\ref{sec:models} assign a local electron temperature as a post-processing step based on local magnetic field strength, parameterized by plasma $\beta$ (Equation \ref{eq:rhigh_prescription} and Equation \vd{ref. critical-$\beta$ equation}).
...
\subsection{Effect of fluid adiabatic index, $\Gamma_\mathrm{ad}$}
