...
\begin{figure*}
  ...
  \caption{Modulation index computed over 3 hour intervals $\mi{3}$ for a subset of the thermal models (\kharma data sets). For this analysis, we considered the (25,000--30,000)$\gt$ time interval.}
  \label{fig:mi_rlow}
\end{figure*}
